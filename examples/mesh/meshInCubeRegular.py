...
# ax.plot( nodes[[0,5],0], nodes[[0,5],1], nodes[[0,5],2], 'm' )
# ax.plot( nodes[[1,6],0], nodes[[1,6],1], nodes[[1,6],2], 'm' )
# ax.plot( nodes[[2,4],0], nodes[[2,4],1], nodes[[2,4],2], 'm' )

# ax.add_collection3d( Poly3DCollection( [list(nodes[[0,5,6]]) ], alpha=0.5 ) )
